...
import 'package:digicapp/page/card/frm_card_preview.dart';
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        setState1(() {
                                          ...
                                          refresh_list_link_select("Restaurants");
                                        });
                                      },
                                      child: Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Text("Restaurants", style: list_text_stayl[3]),
                                      ),
                                    ),
                                    GestureDetector(
                                      onTap: () {
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          if (list_image_send_ftp[0]['file'] == null) {}

                          if (list_image_send_ftp[1]['file'] == null) {}
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  Get.to(qr_code(
                                    val_qr: "https://$address_ip/registration/accessories/$code_card",
                                    type_frm_qr: 2,
                                  ));
                                },
                                child: Image.network(
                  ...
                  Expanded(
                      ...
                      child: btn_digica_1(
                          onPressed: () async {
                            ...
                            await select_tbl_card_user_id_titr(list_text_edite_val_card[0].text);
                            if (list_card_select.isEmpty) {
                              ...
                              await insertCard(
                                  ...
                                  selectedColor_bkcard.toString(),
                                  selectedColor_qr.toString(),
                                  code_card,
